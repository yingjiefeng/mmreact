...
var mimagelist = React.createClass({
    /*--  lifecycle --*/
    ...
    getByFetch : function(){
        ...
        //调用native module过去数据
        var params = {
            url:'http://m.mm131.com/xinggan/2847.html',
            pageNo:1
        };
        jsoupModule.mimagelist(JSON.stringify(params),(status,data)=>{
            //成功
            console.log('mimagelist=='+data);
           ...
           //失败
            console.log('mimagelist=='+exception);
            });
    },
